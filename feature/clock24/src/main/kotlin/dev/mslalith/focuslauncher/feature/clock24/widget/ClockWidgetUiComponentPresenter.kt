...
class ClockWidgetUiComponentPresenter @Inject constructor(
    ...
    override fun present(): ClockWidgetUiComponentState {
        ...
        val showClock24 by clockSettingsRepo.showClock24Flow.collectAsRetainedState(initial = Constants.Defaults.Settings.Clock.DEFAULT_SHOW_CLOCK_24)
        val use24Hour by clockSettingsRepo.use24HourFlow.collectAsRetainedState(initial = Constants.Defaults.Settings.Clock.DEFAULT_USE_24_HOUR)
        val clockAlignment by clockSettingsRepo.clockAlignmentFlow.collectAsRetainedState(initial = Constants.Defaults.Settings.Clock.DEFAULT_CLOCK_ALIGNMENT)
        val clock24AnimationDuration by clockSettingsRepo.clock24AnimationDurationFlow.collectAsRetainedState(initial = Constants.Defaults.Settings.Clock.DEFAULT_CLOCK_24_ANIMATION_DURATION)
